...
|----------------------------------|---------------------------|-----------------------------------------|
| Développement d’un tableau de bord collaboratif avec Next.js, intégrant des services comme Nextcloud, Gitea ou Rocket.Chat. Mise en place d’un SSO centralisé via Keycloak et OpenLDAP, avec une gestion avancée des rôles via JWT. Configuration sécurisée avec Nginx et HTTPS, et contrôle d’accès dynamique. Automatisation de workflows interservices via n8n (webhooks, API, triggers personnalisés).  | Alternance chez ICMAAE (2024 - 2025)     | Next.js, Keycloak, n8n, Nginx           |
